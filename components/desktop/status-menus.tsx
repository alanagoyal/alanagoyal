...
const menuContainerClass = "absolute top-7 rounded-lg bg-white/95 dark:bg-zinc-800/95 backdrop-blur-xl shadow-2xl border border-black/10 dark:border-white/10 py-1 z-[1000] overflow-hidden";
...
export function ControlCenterMenu({ isOpen, onClose, onOpenSettings }: ControlCenterMenuProps) {
  ...
  return (
    <div ref={menuRef} className={cn(menuContainerClass, "w-64 p-2")} style={{ right: "70px" }}>
      {/* Wi-Fi & Bluetooth row */}
