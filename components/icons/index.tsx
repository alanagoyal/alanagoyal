...
export const Icons = {
  ...
  phone: (props: IconProps) => (
    <Phone className="text-muted-foreground" size={16} {...props} />
  ),
  video: (props: IconProps) => (
    <Video className="text-muted-foreground" size={16} {...props} />
  ),
  smile: (props: IconProps) => (
    <Smile className="text-muted-foreground" size={16} {...props} />
  ),
  info: (props: IconProps) => (
    <InfoIcon className="text-muted-foreground" size={16} {...props} />
  ),
  ...
  back: (props: IconProps) => (
    <ChevronLeft className="text-[#0A7CFF]" size={32} {...props} />
  ),
  sun: (props: IconProps) => (
  ...
  plus: (props: IconProps) => (
    <PlusCircle className="text-muted-foreground" size={16} {...props} />
  ),
